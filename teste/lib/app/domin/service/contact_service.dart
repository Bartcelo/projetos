...
class ContactService {
  ...
  validaname(String name) {
    ...
    var max = 50;
    if (name == null) {
      throw DomainLayerExption("O nome é obrigatório.");
    } else if (name.length < mim) {
  ...
  validainforma(String informa) {
    if (informa == null) {
      throw DomainLayerExption("Deve ser colocado informações sobre o cotato feito.");
    } else if (informa.length > 500){
      throw DomainLayerExption("As informações devem conter no maximo 500 caracteres.");
    }
  }
  ...
  validatelefone(String telefone){
    if (telefone == null) {
      ...
      throw DomainLayerExption("O numero do telefone deve possuir onve digitos.");
    }
  }
  ...
  validadata(int data){
    if (data == null) {
      ...
      throw DomainLayerExption("A data deve possuir seis digitos sendo dois para dia dois para mes e dois para ano.");
    }
  }
